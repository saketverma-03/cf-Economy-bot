...
export const updateCommunityByGuildId = (guildId: string, updatedData: Omit<CreateCommunityProps, "guildId">) => {
  return community.findOneAndUpdate({ _id: guildId }, updatedData)
}

export const updateCommunityById = (id: string, updatedData: Omit<CreateCommunityProps, "guildId">) => updateCommunityByGuildId(id, updatedData)
